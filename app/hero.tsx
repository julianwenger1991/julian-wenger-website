        ...
        <div className="flex flex-col items-center md:flex-row md:items-start md:justify-between">
          ...
          <div className="w-full md:w-auto md:mr-8 md:order-1">
            <div className="flex items-center justify-center md:justify-between mb-2 sm:mb-4">
              <h1 className="text-2xl sm:text-3xl md:text-5xl font-bold text-black-900 mr-4">Julian Wenger</h1>
            ...
            <p className="text-base sm:text-lg md:text-xl text-black-700 mb-3 sm:mb-6 text-center md:text-left">LEAN Consultant & Civil Engineer</p>
            <div className="flex items-center justify-center md:justify-start mb-1 sm:mb-2">
              ...
              <p className="text-sm sm:text-base md:text-lg text-black-700">+436766603317</p>
            </div>
            <div className="flex items-center justify-center md:justify-start mb-1 sm:mb-2">
              <MdEmail className="mr-2 text-black-600 text-sm sm:text-base md:text-lg" />
              <p className="text-sm sm:text-base md:text-lg text-black-700">julianwenger1991@gmail.com</p>
            </div>
          </div>
        </div>
      </div>
